...
<div class="container p-3 m-4 h-100"
    ...
    <table>
        <form action="{{ route('buku.destroy', $buku->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <tr>
                <td>
                    <input type="file" accept="image/jpeg" class="form-control mt-2 mb-2 @error('gambar') is-invalid @enderror" id="gambar" name="gambar" required value="{{ asset('storage/'.$buku->gambar) }}">
                </td>
                @error('gambar')
                <div class="invalid-feedback">
                    {{ $message }}
