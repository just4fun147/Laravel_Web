...
<div class="container p-3 m-4 h-100"
    ...
    <hr>
    <table>
        <form action="{{ route('majalah.destroy', $majalah->id) }}" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
            <tr>
                <td>Nama Majalah</td>
            ...
            <tr>
                <td>
                    ...
                    value="{{ $majalah->judul }}" placeholder="Judul Majalah" />
                </td>
                @error('judul')
            ...
            <tr>
                <td>
                    ...
                    value="{{ $majalah->topik }}" placeholder="Topik Majalah" />
                </td>
                @error('topik')
                <div class="invalid-feedback">
                    {{ $message }}
            ...
            <tr>
                <td>
                    ...
                    value="{{ $majalah->jumlah_halaman }}" placeholder="Jumlah Halaman" />
                </td>
            ...
            <tr>
                <td>
                    ...
                    value="{{ $majalah->harga }}" placeholder="Harga Majalah" />
                </td>
                @error('harga')
                <div class="invalid-feedback">
                    {{ $message }}
